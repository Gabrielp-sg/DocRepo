{
  "changed": false,
  "msg": "account_name AM\\guimd is not a valid account, cannot get SID: Exception calling \"Translate\" with \"1\" argument(s): \"Some or all identity references could not be translated.\"",
