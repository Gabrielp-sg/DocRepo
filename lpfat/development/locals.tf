locals {
  ...
  #Locals for ACM and DD
  domains_name = ["lpfat.dev.lpbr.internal.leaseplan.systems"]

  # name_prefix            = format("%s-%s-sae1", local.workload_number, local.environment_identifier)
  ...
  #ACM
  certificate_authority_arn = "arn:aws:acm-pca:sa-east-1:628335837393:certificate-authority/76ebcb5a-0629-4daf-83d7-64e5bc57f510" #TODO: Get this via a data source
